<template>
    <div class="trackers">
        ...
        <div class="header-buttons">
            ...
            <button class="button" @click="showDiv = 'petitiontracker'">Petitions</button>
        </div>

        <div v-if="showDiv === 'billtracker'" class="show">
            <ModalPopup buttonLabel="Add Bill">
            ...
            <!-- Add your content for the Bills tracker here -->
        </div>
        <div v-if="showDiv === 'motiontracker'" class="show">
        ...
        <div v-if="showDiv === 'petitiontracker'" class="show">
        ...
        <table>
            ...
            <tbody>
                <tr v-for="document in tableref" :key="document.id">
                    ...
                    <td><a href="#" @click="this.$router.push({ name: 'documents', params: { id: document.id } })">View
                            Details</a></td>
                    <td>
                        <nav>
                    ...
                    <td>
                        ...
                        <ModalPopup :buttonLabel="`update: ${document.document}`" :buttonClass="customButtonClass"
                            :iconClass="customIconClass">

                            <FileActivities :fileid="document.id" :title="document.title"
...
export default {
    ...
    setup() {
        ...
        const showDiv = ref('petitiontracker');
