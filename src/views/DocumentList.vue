                ...
                <div class="document-list">
                    <ul>
                        <li v-for="document in documents" :key="document.id" class="document-item">
                            ...
                            <!-- <p>{{ document.file }}</p> -->
                            <p>{{ document.size }}</p>
                            <a :href="document.file" target="_blank" class="document-link"><i
                ...
                <table>
                    ...
                    <tbody>
                        <tr v-for="document in documents" :key="document.id">
                            ...
                            <td><a href="#"
                                    @click="this.$router.push({ name: 'documents', params: { id: document.id } })">View
                                    Details</a></td>
                            <td>

                                <ModalPopup :buttonLabel="` Preview:   ${document.name}`" :buttonClass="customButtonClass">
                            ...
                            <td>
                                ...
                                <ModalPopup :buttonLabel="`Add Activity for: ${document.document}`" :buttonClass="customButtonClass"
