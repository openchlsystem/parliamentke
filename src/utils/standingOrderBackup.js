export const StandingOrders = [
...

  {
    ...
    parent: 1,
    heirarchy: "Header",
    "content ": "In cases not provtext_ided for, the Speaker to dectext_ide",
  },
  {
    text_id: 39,
    date: "2023-10-23T07:20:13.111650Z",
  ...
  },
  {
    ...
    parent: 1,
    heirarchy: "Header",
    content: "Nomination of candtext_idates",
  },
  {
    text_id: 44,
    date: "2023-10-23T07:20:13.111650Z",
  ...
  },
  {
    ...
    document: "Standing Orders",
    heirarchy: "Header",
    content: "Prestext_iding in the House",
    parent: 2,
  },
  {
    text_id: 58,
  ...
  },
  {
    ...
    document: "Standing Orders",
    heirarchy: "Header",
    content: "Prestext_idents address on opening of new Parliament",
    parent: 4,
  },
  {
    text_id: 61,
    ...
    document: "Standing Orders",
    heirarchy: "Header",
    content: "Prestext_ident address on special sittings",
    parent: 4,
  },
  {
    text_id: 62,
    ...
    document: "Standing Orders",
    heirarchy: "Header",
    content: "Prestext_ident entering or leaving the Chamber",
    parent: 4,
  },
  {
    text_id: 63,
    ...
    document: "Standing Orders",
    heirarchy: "Header",
    content: "Prestext_idents address to Parliament",
    parent: 4,
  },
  {
    text_id: 66,
  ...
  },
  {
    ...
    document: "Standing Orders",
    heirarchy: "Header",
    content: "Manner of disposing Questions in a Committee",
    parent: 8,
  },
  {
    text_id: 87,
    ...
    document: "Standing Orders",
    heirarchy: "Header",
    content: "Questions for written reply",
    parent: 8,
  },
  {
    text_id: 88,
  ...
  },
  {
    ...
    heirarchy: "Paragraph",
    content:
      "“Prestext_ident” means the Prestext_ident of the Republic of Kenya and includes the Deputy-Prestext_ident when acting as Prestext_ident and any other person who for the time being performs the functions of the Prestext_ident pursuant to Article 146(2) of the Constitution;",
    parent: null,
  },
  {
    text_id: 163,
  ...
  },
  {
    ...
    heirarchy: "Paragraph",
    content:
      "A candtext_idate may, by written notice to the Clerk, withdraw his or her name before a ballot is started, and in the event of such withdrawal, the Clerk shall cross-out the name of that candtext_idate off any ballot papers issued for that or any subsequent ballot.",
    parent: 1,
  },
  {
    text_id: 197,
  ...
  },
  {
    ...
    heirarchy: "Paragraph",
    content:
      "Whenever the Prestext_ident addresses Parliament, the Speaker of the National Assembly shall take the seat on the right of the Prestext_ident and the Speaker of the Senate shall take the seat on the left of the President",
    parent: 4,
  },
  {
    text_id: 324,
  ...
  },
  {
    ...
    heirarchy: "Paragraph",
    content:
      "Whenever the Prestext_ident delivers an Address, a Member may as soon as practicable thereafter, lay the Address on the Table of the House following the reading of such Address",
    parent: 4,
  },
  {
    text_id: 327,
  ...
  },
  {
    ...
    heirarchy: "Paragraph",
    content:
      "If a message is received from the Prestext_ident, at a time when the House is not in session, the Speaker shall forthwith cause the message to be transmitted to every Member and shall report the message to the House on the day the House next sits.",
    parent: 8,
  },
  {
    text_id: 381,
    ...
    heirarchy: "Paragraph",
    content:
      "When a message from the Prestext_ident is read, the message shall be deemed to have been latext_id before the House and the Speaker may either—\n(a) direct that the message be dealt with forthwith; or\n(b) appoint a day for the constext_ideration of the message; or\n(c) refer the message to the relevant Committee of the House for constext_ideration.",
    parent: 8,
  },
  {
    text_id: 382,
